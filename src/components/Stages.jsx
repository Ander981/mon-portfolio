...
const Stages = () => {
  ...
  >
    ...
    <span className="text-lg tracking-wide">Télécharger mon rapport de projet 2 </span>
  </motion.a>
  </div>
...
<br />
 ...
 <div>
  ...
  >
    ...
    <span className="text-lg tracking-wide">Télécharger mon rapport de projet 1 </span>
  </motion.a>
  </div>
