      ...
      >
        ...
        <div className=" z-10">
          <h1 className={`${styles.heroHeadText} text-white`}>
            Bonjour, je suis <span className="text-[#915EFF]">MICHEL Anderson</span>
          </h1>
          ...
          <div className="relative top-10">
            <div className="flex justify-start items-center  ">
              <a className="mr-2" href="https://github.com/Ander981" target="blanc">
                <img
              ...
              <a href="https://x.com/AndersonMI70997" target="blanc">
                <img
